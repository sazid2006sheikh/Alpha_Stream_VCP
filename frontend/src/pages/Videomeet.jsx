...
export default function VideoMeetComponent() {
    ...
    const getPermissions = async () => {
        try {
            ...
            // Use the local permission results rather than state (state updates are async)
    ...
    if (!window.gotMessageFromServer) {
        window.gotMessageFromServer = (fromId, message) => {
    ...
    const gotMessageFromServer = window.gotMessageFromServer;
